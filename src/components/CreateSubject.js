    ...
    return (
        ...
        <div className="w-screen h-screenbg-white ">
            ...
            <div className="w-screen h-screen flex flex-col justify-start items-center">
                <h1 className="text-5xl font-bold text-slate-800 mt-20 m-5 2xl:text-6xl 2xl:mt-40">Let's create a subject</h1>
                <h3 className="text-base text-slate-600">Subjects allow you to organize your flashcards and quizzes</h3>
                <input onChange={(e) => { if (subjectName.length > 0) { setErrorMessage("") } setName(e.target.value) }} type="text" name="subjectName" placeholder="enter a subject name" className="w-1/4 2xl:w-1/6 border-2 rounded-xl p-2 mt-14 border-blue-800 placeholder-slate-300 text-center outline-none" />
