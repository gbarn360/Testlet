...
export default function FlashcardSet({ subjectName, setId, title, description, deleteSet }) {
    ...
    return (
        <div onMouseEnter={() => setIsHovered(true)}
            ...
            className="md:w-1/2 bg-white shadow-md rounded-lg m-5 flex flex-row p-5 justify-between hover:bg-slate-800 transition-colors duration-200 xl:w-3/4 2xl:w-2/3 xl:ml-10">
