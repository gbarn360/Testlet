    ...
    return (
        <div className="" >
            ...
            <div className="w-auto h-screen ">
                ...
                <div className="lg:w-1/3 lg:h-1/2  lg:absolute lg:z-10 lg:top-1/4 lg:left-20 flex flex-col lg:items-start items-center">
                    <h1 className="text-5xl md:text-5xl font-bold lg:text-slate-100 text-center mt-10 ml-2 mr-2 lg:mt-0 lg:ml-0 lg:mr-0 text-slate-800">Discover the best way to study</h1>
                    <h3 className="lg:text-md font-bold lg:text-slate-300 lg:mt-8 mt-10 md:w-2/3 lg:w-5/6 text-center text-slate-400 w-5/6">Join one of the fastest growing digital study tools used by millions across the globe Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</h3>
