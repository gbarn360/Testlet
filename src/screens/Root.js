        ...
        <div className="" >
            ...
            <div className="w-auto mb-40 ">
                ...
                <div className="lg:w-1/3 xl:w-1/3 lg:h-1/2  lg:absolute lg:z-10 lg:top-1/4 lg:left-20 flex flex-col lg:items-start 2xl:w-1/3 2xl:items-center items-center">
                    <h1 className="text-slate-800 text-5xl md:text-5xl font-bold  text-center mt-10 ml-2 mr-2 lg:mt-0 lg:ml-0 lg:mr-0  2xl:text-7xl lg:text-white drop-shadow-md">Discover the best way to study</h1>
