    ...
    return (
        <div >
            ...
            <div className="w-screen h-auto flex flex-col bg-slate-100 " >
                <div className="w-screen h-2/5  flex flex-col md:flex-row items-center justify-start">
                ...
                <div className="w-screen h-auto mt-5 2xl:mt-16">
                    ...
                    <div className={subjects.length == 0 ? "h-screen" : "grid grid-cols-2 md:grid-cols-3 justify-items-center mt-10 2xl:grid-cols-4"}>
